    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <a class="navbar-brand" href="#"><img src="<?= Yii::$app->view->theme->baseUrl ?>/images/logo.png" class="main-logo"/></a>
            </div>
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    ...
                    if (!Yii::$app->getUser()->isGuest):
                        echo Nav::widget([
                            ...
                            'encodeLabels' => false,
                            'items' => [
                                ['label' => Yii::t('app', 'Dashboard'), 'url' => ['/dashboard/dashboard'], 'visible' => Yii::$app->user->can('Dashboard.Dashboard')],
...
<footer class="footer">
    <div class="container">
        <ul class="footer-menu">
            <li>Mentions</li>
            <li>légales Contacts</li>
            <li>Règlement</li>
            <li class="copyright"><?= Yii::$app->params['copyright'] ?></li>
        </ul>
    </div>
</footer>
