...
class CategoryController extends BaseController
{
    ...
    public $layout = 'main-producer'; // Main layout for producer section
    ...
    public function actionViewByStep()
    {
        ...
        if (ArrayHelper::isIn($step, $categoryOrderArr)) {
            ...
            $this->view->params['step'] = $step; //Set the current step to the producer layout
