...
class BaseController extends Controller
{
    ...
    public $layout = 'main-producer'; // Main layout for super admin panel
    ...
    public function beforeAction($action)
    {
        ...
        if (!Yii::$app->getUser()->isGuest &&
            ...
            if (!Yii::$app->user->can($permissionName)) {
                ...
                Yii::$app->getResponse()->redirect(Yii::$app->params['producersAccessDeniedUrl']);
            }
        }
        return true;
    }
    ...
    {
        //Get award categories set it to the producer layout
