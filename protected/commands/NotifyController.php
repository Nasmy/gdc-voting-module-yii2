...
class NotifyController extends Controller
{
    ...
    public function actionPressRelease()
    {
        ...
        $this->voters = $this->voter->find()->active()->limitQuery(6000, 6700)->all();
        ...
        if (!empty($this->voters)) {
            foreach ($this->voters as $voter) {
                ...
                /*if (1186 != $voter->id) { // 13865 - Yohan, 13866 - Rooban, 13867 - Steve, 13868 - Nasmy
                     continue;
                }*/
                ...
                try {
                    ...
                    //continue;
//                    $voter->tokenSent = $this->mail->sendVoterPrese('dilshan@keeneye.solutions', $voter->name, $voter->gender, $votesUrl, $voter->token);
                    $voter->tokenSent = $this->mail->sendVoterPrese($voter->email, $voter->name, $voter->gender, $votesUrl, $voter->token);
...
//                        echo "\n<br />success:" . $success;
    ...
    public function actionSendVoterToken()
    {
        ...
        // $this->voters = $this->voter->find()->active()->notTokenSent()->all();
        $this->voters = $this->voter->find()->active()->notVoted()->notTokenSent()->all();
        // exit;
        if (!empty($this->voters)) {
            ...
            foreach ($this->voters as $voter) {
                ...
                /*if (1186 != $voter->id) { // 1186-Steve 13865 - Yohan, 13866 - Rooban, 13867 - Steve, 13868 - Nasmy
                    continue;
                }*/
    ...
    public function actionSendFirstReminderToVoter()
    {
        ...
        if (!empty($this->voters)) {
            ...
            foreach ($this->voters as $voter) {
                ...
                //echo "\n<br />voter: name: " . $voter->name;
                //echo "\n<br />voter: email: " . $voter->email;
                /*if (1186 != $voter->id) { // 13865 - Yohan, 13866 - Rooban, 5716 - Steve
                    continue;
                }*/
                echo "\n<br />voter: id: " . $voter->id;
                echo "\n<br />voter: name: " . $voter->name;
                echo "\n<br />voter: email: " . $voter->email;
                $firstReminderSent = $this->voterReminder->find()->where(['voterId' => $voter->id, 'remindNo' => 5])->count();
                ...
                try {
                    ...
                    echo "\n<br />votesUrl: " . $votesUrl;
                    //continue;
                    $voter->tokenSent = $this->mail->sendFinalReminderToVoter($voter->email, $voter->name, $voter->gender, $votesUrl, $voter->token);
                    echo "\n<br />tokenSent: " . $voter->tokenSent;
