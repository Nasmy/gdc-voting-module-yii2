...
<div class="voter-search col-md-9">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <?= $form->field($model, 'status')->dropDownList([Voter::STATUS_INACTIVE => Yii::t('app', 'Inactive'), Voter::STATUS_ACTIVE => Yii::t('app', 'Active')], ['prompt' => Yii::t('app', '- Status -')])->label(false); ?>
        </div>
        <div class="col-md-2">
