...
<div class="permission-search">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <?= $form->field($model, 'category')->textInput(['placeholder' => $model->getAttributeLabel('category')])->label(false) ?>
        </div>
        <div class="col-md-2">
            <?= $form->field($model, 'subCategory')->textInput(['placeholder' => $model->getAttributeLabel('subCategory')])->label(false) ?>
        </div>
        <div class="col-md-2">
