...
<div class="user-form">
    ...
    <div class="row">
        <div class="col-md-6">
            <?= $form->field($model, 'formPassword')->passwordInput(['autocomplete' => 'off', 'placeholder' => $model->getAttributeLabel('oldPassword')])->label($model->getAttributeLabel('oldPassword')) ?>
